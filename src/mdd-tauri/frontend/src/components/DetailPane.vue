            ...
            <thead class="sticky top-0 bg-[#0e1018] z-10">
              <tr class="border-b border-gray-800/80">
                <th
                  ...
                  :key="ci"
                  class="text-left px-3 py-2 text-[0.85em] text-gray-500 font-medium uppercase tracking-wider cursor-pointer hover:text-gray-300 select-none relative group"
                  :style="colStyle(ci)"
                  @click="toggleSort(ci)"
                >
                  <span>{{ cell.text }}</span>
            ...
            <tbody>
              ...
              >
                <td
                  ...
                  :key="ci"
                  class="px-3 py-1.5 text-gray-400 truncate"
                  :class="{
